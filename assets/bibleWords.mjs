...
let bibleWords = [
    ...
    {word: 'Egypt', scriptureRef: 'Exodus 12:40', link: 'https://www.biblegateway.com/passage/?search=Exodus%2012&version=NIV', scripture: 'Now the length of time the Israelite people lived in <b>Egypt</b> was 430 years.', clue: 'This location was where Joseph was sold into slavery.', clueBook: 'N/A'}    
];
